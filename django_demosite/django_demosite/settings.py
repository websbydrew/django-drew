"""
Django settings for django_demosite project.
...
SECRET_KEY = 'v6k3fv=ui!*+=x2oidmf*!n-40-ad04xqi!l#-@kng(w!@81$d'
...
ROOT_URLCONF = 'django_demosite.urls'
...
STATICFILES_DIRS = (
    ('assets', '/Users/andrewhaberman/Desktop/django-drew/django_demosite/static'),
)
